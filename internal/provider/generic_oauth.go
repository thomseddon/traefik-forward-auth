...
type GenericOAuth struct {
	...
	TokenURL     string   `long:"token-url" env:"LOGIN_URL" description:"Login URL"`
...
func (o *GenericOAuth) Setup() error {
	// Check parmas
	if o.LoginURL == "" || o.TokenURL == "" || o.UserURL == "" || o.ClientID == "" || o.ClientSecret == "" {
		return errors.New("providers.generic-oauth.login-url, providers.generic-oauth.token-url, providers.generic-oauth.user-url, providers.generic-oauth.client-id, providers.generic-oauth.client-secret must be set")
	}
